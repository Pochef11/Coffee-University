                        ...
                        <table class="table mt-5">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td><?php echo $row ['carreta']?></td>
                                    <td><a class="btn btn-info" href="modificarAlumnos.php?ID=<?php echo $row['ID'];?>">
                                    Modificar</a>&nbsp;<a class="btn btn-danger" href="eliminarAL.php?ID=<?php echo $row['ID'];?>">Eliminar</a></td>
                                </tr>
