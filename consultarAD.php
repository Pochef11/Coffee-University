<?php
    ...
    $Consultar = "SELECT * FROM administracion";
                        ...
                        <table class="table mt-5">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td><a class="btn btn-info" href="modificarAD.php?ID=<?php echo $row['ID'];?>">
                                    Modificar</a>&nbsp;<a class="btn btn-danger" href="eliminarAD.php?ID=<?php echo $row['ID'];?>">Eliminar</a></td>
                                </tr>
